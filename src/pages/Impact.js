...
export default function Impact() {
  return (
    <div className="p-6 max-w-5xl mx-auto">
      <h2 className="text-3xl font-bold text-red-700 mb-6">Our Impact</h2>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-10">
        <figure className="shadow-card p-5 flex flex-col items-center">
          ...
          <figcaption className="text-lg text-red-700 font-semibold mb-2">Healthcare: Dr. Jenny's Story</figcaption>
        ...
        <figure className="shadow-card p-5 flex flex-col items-center">
          ...
          <figcaption className="text-lg text-red-700 font-semibold mb-2">Joy & Resilience</figcaption>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-10">
        <figure className="shadow-card p-5 flex flex-col items-center">
          ...
          <figcaption className="text-lg text-red-700 font-semibold mb-2">Mentorship & Literacy</figcaption>
        ...
        <figure className="shadow-card p-5 flex flex-col items-center">
          ...
          <figcaption className="text-lg text-red-700 font-semibold mb-2">Education & Tutoring</figcaption>
