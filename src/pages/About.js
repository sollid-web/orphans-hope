...
export default function About() {
  return (
    <div className="p-6 max-w-5xl mx-auto">
      <h2 className="text-3xl font-bold text-red-700 mb-6">About Orphans Hope</h2>
      ...
      <section className="shadow-card p-6 mb-8" aria-labelledby="about-video-heading">
        <div className="flex flex-col md:flex-row gap-6 items-center">
          ...
          <div className="md:w-1/2">
            <h3 id="about-video-heading" className="text-2xl font-semibold text-red-700 mb-3">Life Inside Our Edmonton Home</h3>
      ...
      <div className="mb-8">
        <h3 className="text-2xl font-semibold text-red-700 mb-4">Our Story</h3>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <figure className="flex flex-col items-center">
          ...
          <figcaption className="text-red-700 font-semibold">Personalized mentorship and literacy development</figcaption>
        </figure>
        <figure className="flex flex-col items-center">
          ...
          <figcaption className="text-red-700 font-semibold">Building confidence through play and recreation</figcaption>
        </figure>
      </div>

      <div className="mb-8">
        <h3 className="text-2xl font-semibold text-red-700 mb-4">Our Mission & Values</h3>
        <div className="grid md:grid-cols-3 gap-6">
          <div className="shadow-card p-5">
            <h4 className="font-semibold text-lg mb-2 text-red-700">Compassion</h4>
          ...
          <div className="shadow-card p-5">
            <h4 className="font-semibold text-lg mb-2 text-red-700">Transparency</h4>
          ...
          <div className="shadow-card p-5">
            <h4 className="font-semibold text-lg mb-2 text-red-700">Empowerment</h4>
      ...
      <div className="mb-8">
        <h3 className="text-2xl font-semibold text-red-700 mb-4">Our Team</h3>
        <p className="mb-4 text-gray-700 leading-relaxed">
      ...
      <div className="mb-8">
        <h3 className="text-2xl font-semibold text-red-700 mb-4">Governance & Compliance</h3>
        <p className="mb-4 text-gray-700 leading-relaxed">
      ...
      <div className="shadow-card p-5 text-center mb-6">
        ...
        <a href="/donate" className="btn-cta inline-flex justify-center w-full sm:w-auto">Donate or Sponsor Today</a>
      </div>
    </div>
  );
}
