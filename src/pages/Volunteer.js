...
export default function Volunteer() {
  return (
    <div className="p-6 max-w-5xl mx-auto">
      <h2 className="text-3xl font-bold text-red-700 mb-6">Volunteer With Us</h2>
      ...
      <div className="mb-8">
        <h3 className="text-2xl font-semibold text-red-700 mb-4">Volunteer Opportunities</h3>
        <div className="grid md:grid-cols-2 gap-6">
          <div className="shadow-card p-5">
            <h4 className="font-semibold text-lg mb-2 text-red-700">Academic Tutoring</h4>
          ...
          <div className="shadow-card p-5">
            <h4 className="font-semibold text-lg mb-2 text-red-700">Recreation & Sports</h4>
          ...
          <div className="shadow-card p-5">
            <h4 className="font-semibold text-lg mb-2 text-red-700">Mentorship Programs</h4>
          ...
          <div className="shadow-card p-5">
            <h4 className="font-semibold text-lg mb-2 text-red-700">Healthcare Professionals</h4>
          ...
          <div className="shadow-card p-5">
            <h4 className="font-semibold text-lg mb-2 text-red-700">Administrative Support</h4>
          ...
          <div className="shadow-card p-5">
            <h4 className="font-semibold text-lg mb-2 text-red-700">Special Events</h4>
      ...
      <div className="mb-8">
        <h3 className="text-2xl font-semibold text-red-700 mb-4">Volunteer Requirements</h3>
      ...
      <div className="mb-8">
        <h3 className="text-2xl font-semibold text-red-700 mb-4">Why Volunteer?</h3>
      ...
      <div className="shadow-card p-6 text-center">
        ...
        <a href="mailto:volunteer@orphanshope.com" className="btn-cta inline-flex justify-center w-full sm:w-auto">Express Interest via Email</a>
      </div>
    </div>
  );
}
