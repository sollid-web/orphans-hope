      ...
      <div className="space-y-8">
        <section className="shadow-card p-6">
          <div className="flex items-center mb-4">
            <h3 className="text-2xl font-semibold text-green-700">Volunteer Your Time</h3>
          </div>
          ...
          <a href="/volunteer" className="btn-green inline-block">Learn About Volunteering</a>
        </section>

        <section className="shadow-card p-6">
          <div className="flex items-center mb-4">
            <h3 className="text-2xl font-semibold text-green-700">Sponsor a Child</h3>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-4">
            <div className="border rounded-lg p-4">
              <h4 className="font-semibold text-lg mb-2 text-green-700">Bronze Sponsor</h4>
            ...
            <div className="border rounded-lg p-4 border-green-700">
              <h4 className="font-semibold text-lg mb-2 text-green-700">Silver Sponsor</h4>
            ...
            <div className="border rounded-lg p-4">
              <h4 className="font-semibold text-lg mb-2 text-green-700">Gold Sponsor</h4>
          ...
          <a href="/donate" className="btn-green inline-block">Become a Sponsor</a>
        </section>

        <section className="shadow-card p-6">
          <div className="flex items-center mb-4">
            <h3 className="text-2xl font-semibold text-green-700">Host a Fundraiser</h3>
          </div>
          ...
          <a href="mailto:fundraising@orphanshope.com" className="btn-green inline-block">Start a Fundraiser</a>
        </section>

        <section className="shadow-card p-6">
          <div className="flex items-center mb-4">
            <h3 className="text-2xl font-semibold text-green-700">Corporate Partnerships</h3>
          </div>
          ...
          <a href="mailto:partnerships@orphanshope.com" className="btn-green inline-block">Explore Corporate Partnerships</a>
        </section>

        <section className="shadow-card p-6">
          <div className="flex items-center mb-4">
            <h3 className="text-2xl font-semibold text-green-700">Donate Goods & Services</h3>
          </div>
          ...
          <a href="mailto:donations@orphanshope.com" className="btn-green inline-block">Contact Us About Donations</a>
        </section>

        <section className="shadow-card p-6">
          <div className="flex items-center mb-4">
            <h3 className="text-2xl font-semibold text-green-700">Spread the Word</h3>
          </div>
